...
def load_data(path="data/cora/", dataset="cora", prefix=""):
    ...
    if dataset == "cora":
        ...
        labels = encode_onehot(idx_features_labels[:,2]+''+idx_features_labels[:,3]+''+idx_features_labels[:,4], dtype=np.float32)
        print(labels[1:100])
